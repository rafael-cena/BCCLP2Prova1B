    ...
    return (
        <Card style={{ width: '18rem' }}>
            ...
            <Card.Body>
                ...
                <Button onClick={() => { setCurtidas((curtidas + 1)) }} variant="primary"> {//Curtir
                }
                ...
                </Button> <Button onClick={() => { setDescurtidas(descurtidas + 1) }} variant="primary"> {//Não Curtir
                }
                ...
                <Button onClick={() => { exDetalhes(props.candidato) }} className="mt-1" variant="success">Conheça minhas propostas</Button>
            </Card.Body>
        </Card>
    );
}